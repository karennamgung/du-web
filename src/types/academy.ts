...
export const DUMMY_ACADEMIES: Academy[] = [
  ...
  { id: '3', name: '송도코딩센터', address: '인천 연수구 송바이오대로 78', subjects: ['코딩', '로봇'], lat: 37.3800, lng: 126.6620 },
  { id: '4', name: '예림국어학원', address: '인천 연수구 인천타워대로 101', subjects: ['국어', '논술'], lat: 37.3880, lng: 126.6540 },
  { id: '5', name: '송도피아노학원', address: '인천 연수구 송도과학로 22', subjects: ['피아노', '음악이론'], lat: 37.3840, lng: 126.6600 },
  { id: '6', name: '다담미술학원', address: '인천 연수구 아트센터대로 56', subjects: ['미술', '디자인'], lat: 37.3780, lng: 126.6560 },
  { id: '7', name: '송도체육관', address: '인천 연수구 스포츠로 33', subjects: ['축구', '농구', '수영'], lat: 37.3900, lng: 126.6620 },
  ...
  { id: '10', name: '키즈발레학원', address: '인천 연수구 송도대로 200', subjects: ['발레', '현대무용'], lat: 37.3790, lng: 126.6640 },
]
